...
<html>
    ...
    <body class="form-body">
        ...
        <section class="item-review">
            <div class="box">
                <form>
                    <h1>Review Accessory</h1>
                    <input name="name" class="input" type="text" placeholder="*Name of Product"required>
                    <input name="type" class="input" type="text" placeholder="*Type of product" required>
